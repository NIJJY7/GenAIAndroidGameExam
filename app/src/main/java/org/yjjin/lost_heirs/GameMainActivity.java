...
import org.yjjin.lost_heirs.common.Constant;
import org.yjjin.lost_heirs.common.GameEngine;
import org.yjjin.lost_heirs.common.Utility;
import org.yjjin.lost_heirs.entity.EventData;
import org.yjjin.lost_heirs.entity.PlaceData;
...
public class GameMainActivity extends AppCompatActivity {
    ...
    private void updateDateTextView() {
        ...
        //String dateText = String.format("10월 1일");
        ...
        if (requestCode == Constant.GM_PLAY) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (gameEngine.getCurPlace() == placeNum) {
                    ...
                    //Utility.playWaveFromDAT(R.raw.select);
                    //마지막 날인지 체크
                    if (gameEngine.getCurMonth() == 10 && gameEngine.getCurDay() == 31) {
                        int maxlove = 0;
                        int maxlovegirl = -1;
